...
public class BasketGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.eshop.api.gateway.BasketOuterClass.BasketRequest,
      com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse> METHOD_GET_BASKET_BY_ID =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "BasketApi.Basket", "GetBasketById"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.eshop.api.gateway.BasketOuterClass.BasketRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse.getDefaultInstance()));
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.eshop.api.gateway.BasketOuterClass.CustomerBasketRequest,
      com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse> METHOD_UPDATE_BASKET =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "BasketApi.Basket", "UpdateBasket"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.eshop.api.gateway.BasketOuterClass.CustomerBasketRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse.getDefaultInstance()));
  ...
  public static abstract class BasketImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBasketById(com.eshop.api.gateway.BasketOuterClass.BasketRequest request,
        io.grpc.stub.StreamObserver<com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_BASKET_BY_ID, responseObserver);
    }

    /**
     */
    public void updateBasket(com.eshop.api.gateway.BasketOuterClass.CustomerBasketRequest request,
        io.grpc.stub.StreamObserver<com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.eshop.api.gateway.BasketOuterClass.BasketRequest,
                com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse>(
                  this, METHODID_GET_BASKET_BY_ID)))
          .addMethod(
            METHOD_UPDATE_BASKET,
            asyncUnaryCall(
              new MethodHandlers<
                com.eshop.api.gateway.BasketOuterClass.CustomerBasketRequest,
                com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse>(
  ...
  public static final class BasketBlockingStub extends io.grpc.stub.AbstractStub<BasketBlockingStub> {
    ...
    /**
     */
    public com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse getBasketById(com.eshop.api.gateway.BasketOuterClass.BasketRequest request) {
    ...
    /**
     */
    public com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse updateBasket(com.eshop.api.gateway.BasketOuterClass.CustomerBasketRequest request) {
      return blockingUnaryCall(
  ...
  public static final class BasketFutureStub extends io.grpc.stub.AbstractStub<BasketFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse> getBasketById(
        com.eshop.api.gateway.BasketOuterClass.BasketRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse> updateBasket(
        com.eshop.api.gateway.BasketOuterClass.CustomerBasketRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BASKET_BY_ID:
          serviceImpl.getBasketById((com.eshop.api.gateway.BasketOuterClass.BasketRequest) request,
              (io.grpc.stub.StreamObserver<com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse>) responseObserver);
          break;
        case METHODID_UPDATE_BASKET:
          serviceImpl.updateBasket((com.eshop.api.gateway.BasketOuterClass.CustomerBasketRequest) request,
              (io.grpc.stub.StreamObserver<com.eshop.api.gateway.BasketOuterClass.CustomerBasketResponse>) responseObserver);
          break;
        default:
  ...
  private static final class BasketDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.eshop.api.gateway.BasketOuterClass.getDescriptor();
    }
  }
